...
namespace Sarina_API.Models
{
    ...
    public class OrderItemDetail
    {
        ...
        public OrderItemDetail(int OrderItemId, int? billId, int OrderItemType, double qty, double? price, double? cgst, double? sgst, double? igst, System.DateTime date, DbContext contextOptions)
        {
        ...
        public OrderItemDetail(int OrderItemId, int? billId, int OrderItemType, double qty, double? price, double? tax1, double? tax2, double? amount, double? taxamount, System.DateTime date, DbContext contextOptions)
        {
            OrderItemId = OrderItemId;
            BillId = billId;
            OrderItemType = OrderItemType;
        ...
        //    get
        //    {
        //        var OrderItemDetail = db.OrderItemDetails.Where(op => op.BillId == BillId && op.Id == Id && op.OrderItemType == (int)Sarina_API.Models.Enum.OrderItemType.Dispatch).FirstOrDefault();
       ...
       // [NotMapped]
        ...
        //        if (Bill.BillType == 2)
        //        {
        //            var OrderItemDetail = db.OrderItemDetails.Where(op => op.BillId == BillId && op.Id == Id && op.OrderItemType == (int)Sarina_API.Models.Enum.OrderItemType.Return).FirstOrDefault();
        //            if (OrderItemDetail == null)
        //                return 0;
        //            else
        //                return OrderItemDetail.Quantity;
        ...
        //        else
        //        {
        //            var OrderItemDetail = db.OrderItemDetails.Where(op => op.BillId == BillId && op.Id == Id && op.OrderItemType == (int)Sarina_API.Models.Enum.OrderItemType.Return);
        ...
        //    get
        //    {
        //        var OrderItemDetail = db.OrderItemDetails.Where(op => op.BillId == BillId && op.Id == Id && op.OrderItemType == (int)Sarina_API.Models.Enum.OrderItemType.Receive).FirstOrDefault();
        //        if (OrderItemDetail == null)
        //            return 0;
        //        else
        //            return OrderItemDetail.Quantity;
